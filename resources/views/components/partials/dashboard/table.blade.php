<div
    ...
    <h4 class="mb-6 text-xl font-bold text-black dark:text-white-dahsboard">
        Top Channels
    </h4>

    <div class="flex flex-col">
        <div class="grid grid-cols-3 rounded-sm bg-gray-2-dashboard dark:bg-meta-4 sm:grid-cols-5">
        ...
        <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
            <div class="flex items-center gap-3 p-2.5 xl:p-5">
                ...
                <p class="hidden font-medium text-black dark:text-white-dahsboard sm:block">
                    Google
                </p>
            </div>

            <div class="flex items-center justify-center p-2.5 xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">3.5K</p>
            </div>
            ...
            <div class="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">590</p>
            </div>
        ...
        <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
            ...
            <div class="flex items-center justify-center p-2.5 xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">2.2K</p>
            </div>
            ...
            <div class="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">467</p>
            </div>
        ...
        <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
            ...
            <div class="flex items-center justify-center p-2.5 xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">2.1K</p>
            </div>
            ...
            <div class="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">420</p>
            </div>
        ...
        <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
            ...
            <div class="flex items-center justify-center p-2.5 xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">1.5K</p>
            </div>
            ...
            <div class="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">389</p>
            </div>
        ...
        <div class="grid grid-cols-3 sm:grid-cols-5">
            ...
            <div class="flex items-center justify-center p-2.5 xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">1.2K</p>
            </div>
            ...
            <div class="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
                <p class="font-medium text-black dark:text-white-dahsboard">230</p>
            </div>
