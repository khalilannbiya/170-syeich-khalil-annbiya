        ...
        <nav class="px-4 py-4 mt-5 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    <!-- Menu Item Dashboard -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4 {{ Route::current()->getName() == strtolower(auth()->user()->role->name) . '.dashboard' ? 'bg-graydark-dashboard dark:bg-meta-4' : '' }}"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4"
                            ...
                            :class="{
                                'bg-graydark-dashboard dark:bg-meta-4': (selected === 'UiElements') || (
                                    page === 'alerts' ||
                                    page === 'buttons')
                            }">
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul class="flex flex-col gap-2 pl-6 mt-4 mb-3">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-dahsboard"
                                        href="alerts.html"
                                        :class="page === 'alerts' && '!text-white-dahsboard'">Alerts</a>
                                </li>

                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-dahsboard"
                                        href="buttons.html"
                                        :class="page === 'buttons' && '!text-white-dahsboard'">Buttons</a>
                                </li>
                            </ul>
                        </div>
                        <!-- Dropdown Menu End -->
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4"
                            ...
                            :class="{
                                'bg-graydark-dashboard dark:bg-meta-4': (selected === 'AuthPages') || (
                                    page === 'register' ||
                                    page === 'login')
                            }">
                            <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none"
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul class="flex flex-col gap-2 pl-6 mt-4 mb-3">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-dahsboard"
                                        href="signin.html"
                                        :class="page === 'signin' && '!text-white-dahsboard'">Sign
                                        In</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-dahsboard"
                                        href="signup.html"
                                        :class="page === 'signup' && '!text-white-dahsboard'">Sign
                                        Up</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <!-- Menu Item Profile -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4 {{ Route::current()->getName() == strtolower(auth()->user()->role->name) . '.users.index' ? 'bg-graydark-dashboard dark:bg-meta-4' : '' }}"
                            href="{{ route(strtolower(auth()->user()->role->name) . '.users.index') }}">
                    ...
                    @if (strtolower(auth()->user()->role->name) == 'adminisrator')
                        <!-- Menu Item Profile -->
                        <li>
                            <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4 {{ Route::current()->getName() == 'adminisrator.users.officer.getDataOfficer' ? 'bg-graydark-dashboard dark:bg-meta-4' : '' }}"
                                href="{{ route('adminisrator.users.officer.getDataOfficer') }}">
                                <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M9.0002 7.79065C11.0814 7.79065 12.7689 6.1594 12.7689 4.1344C12.7689 2.1094 11.0814 0.478149 9.0002 0.478149C6.91895 0.478149 5.23145 2.1094 5.23145 4.1344C5.23145 6.1594 6.91895 7.79065 9.0002 7.79065ZM9.0002 1.7719C10.3783 1.7719 11.5033 2.84065 11.5033 4.16252C11.5033 5.4844 10.3783 6.55315 9.0002 6.55315C7.62207 6.55315 6.49707 5.4844 6.49707 4.16252C6.49707 2.84065 7.62207 1.7719 9.0002 1.7719Z"
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4"
                            ...
                            :class="{
                                'bg-graydark-dashboard dark:bg-meta-4': (selected === 'Forms') || (
                                    page === 'formElements' ||
                                    page === 'formLayout')
                            }">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-dahsboard"
                                        ...
                                        :class="page === 'formElements' && '!text-white-dahsboard'">Form Elements</a>
                                </li>
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-dahsboard"
                                        href="form-layout.html"
                                        :class="page === 'formLayout' && '!text-white-dahsboard'">Form
                                        Layout</a>
                                </li>
                            </ul>
                        </div>
