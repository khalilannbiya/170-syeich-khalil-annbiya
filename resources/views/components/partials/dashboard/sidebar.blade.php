                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4"
                            ...
                            :class="{
                                'bg-graydark-dashboard dark:bg-meta-4': (selected === 'Dashboard') || (
                                    page === 'ecommerce' ||
                        ...
                        <div class="overflow-hidden transform translate"
                            ...
                            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white-dahsboard"
                                        href="index.html"
                                        :class="page === 'ecommerce' && '!text-white-dahsboard'">eCommerce
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4"
                            ...
                            :class="{
                                'bg-graydark-dashboard dark:bg-meta-4': (selected === 'Profile') && (
                                    page === 'profile')
                            }"
                            :class="page === 'profile' && 'bg-graydark-dashboard'">
                            <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18"
                                fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
