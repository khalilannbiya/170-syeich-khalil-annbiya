        ...
        <nav class="px-4 py-4 mt-5 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    <!-- Menu Item Dashboard -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4 {{ Route::current()->getName() == 'adminisrator.dashboard' ? 'bg-graydark-dashboard dark:bg-meta-4' : '' }}"
                            href="{{ route('adminisrator.dashboard') }}">
            ...
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    <!-- Menu Item Profile -->
                    <li>
                        <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark-dashboard dark:hover:bg-meta-4 {{ Route::current()->getName() == 'adminisrator.users.index' ? 'bg-graydark-dashboard dark:bg-meta-4' : '' }}"
                            href="{{ route('adminisrator.users.index') }}">
