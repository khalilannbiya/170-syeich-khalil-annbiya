<article
    {{ $attributes->merge(['class' => 'group flex w-full h-[20rem] md:h-[25rem] lg:h-[20rem] sm:max-w-lg md:max-w-[22rem] lg:max-w-md xl:max-w-sm  flex-col rounded-md bg-white bg-clip-border text-gray-700 shadow-md hover:shadow-2xl transition-all duration-700 ease-in-out']) }}>
