<x-layouts.dashboard>
    <x-slot:title>Edit Divisi | </x-slot:title>
    ...
    <div>
        ...
        <nav class="mb-5">
            <ol class="flex items-center gap-2">
                ...
                <li>
                    <a class="font-medium" href="{{ route('adminisrator.divisions.index') }}">Data Divisi
                        /</a>
                </li>
                <li class="font-medium text-primary">Edit Divisi</li>
            </ol>
        </nav>
        ...
        <div
            ...
            <div class="p-6.5">
                <form action="{{ route('adminisrator.divisions.update', $division->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-4.5">
                        <label for="name"
                        ...
                        <input type="text" name="name" autocomplete="name" maxlength="100" autofocus
                            value="{{ $division->name }}"
                    ...
                    <div class="mb-4.5">
                        ...
                        <textarea rows="6" name="description" autocomplete="description"
                        ...
                        <x-partials.frontend.input-error :messages="$errors->get('description')" class="mt-2" />
                    </div>
