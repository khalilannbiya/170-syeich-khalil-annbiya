    ...
    <div>
        ...
        <nav class="mb-5">
            <ol class="flex items-center gap-2">
                ...
                <li>
                    <a class="font-medium" href="{{ route('adminisrator.categories.index') }}">Data Kategori
                        /</a>
                </li>
                <li class="font-medium text-primary">Edit Kategori</li>
            </ol>
        </nav>
        ...
        <div
            ...
            <div class="p-6.5">
                <form action="{{ route('adminisrator.categories.update', $category->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="mb-4.5">
                        <label for="name"
