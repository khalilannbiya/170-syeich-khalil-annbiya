    ...
    <section class="flex flex-col items-center justify-center gap-6">
        <section class="w-full pt-10 max-w-7xl md:py-6 ">
            ...
            <form action="#" method="POST" class="mt-5 md:mt-7 lg:mt-8 lg:px-32 xl:px-40"
                ...
                <section class="mt-16">
                    <h2 class="text-xl font-semibold">Bukti-bukti</h2>
                    <p class="text-xs font-semibold text-red-500">* Jika tidak ada bukti, boleh dihiraukan</p>
                    <p class="text-xs font-semibold text-red-500">* Boleh memasukan lebih dari 1 bukti, dengan cara
                    ...
                    <section>
                        ...
                        <div class="mt-5">
                            ...
                            <input type="file" name="photos[]" id="photos" value="{{ old('photos') }}"
                                class="mt-2 ">
                            @error('photos')
                                <p class="mt-2 text-sm font-medium text-red-500">{{ $message }}</p>
                            @enderror
                ...
                <section class="mt-16">
                    <h2 class="text-xl font-semibold">Saksi-saksi</h2>
                    <p class="text-xs font-semibold text-red-500">* Jika tidak ada saksi, boleh dihiraukan</p>
                    <p class="text-xs font-semibold text-red-500">* Boleh memasukan lebih dari 1 saksi, dengan cara
                    ...
                    <section>
                        ...
                        <div class="mt-5">
                            ...
                            <input type="text" id="phoneWitnesses" name="phoneWitnesses[]"
                                value="{{ old('phoneWitnesses') }}" placeholder="Masukan Nomor Telepon Saksi 1"
                                maxlength="20"
                                class="w-full mt-2 transition duration-500 ease-in-out rounded ring-1 ring-black focus:outline-none focus:ring-2 focus:ring-deep-koamaru-700 focus:border-transparent">
                    ...
                    <section>
                        ...
                        <div class="mt-5">
                            <label for="phoneWitnesses" class="font-bold">Nomor Telepon Saksi</label>
                            <input type="text" id="phoneWitnesses" name="phoneWitnesses[]"
                                value="{{ old('phoneWitnesses') }}" placeholder="Masukan Nomor Telepon Saksi 2"
                                maxlength="20"
                                class="w-full mt-2 transition duration-500 ease-in-out rounded ring-1 ring-black focus:outline-none focus:ring-2 focus:ring-deep-koamaru-700 focus:border-transparent">
                            @error('phoneWitnesses')
                                <p class="mt-2 text-sm font-medium text-red-500">{{ $message }}</p>
                    ...
                    <section>
                        ...
                        <div class="mt-5">
                            <label for="phoneWitnesses" class="font-bold">Nomor Telepon Saksi</label>
                            <input type="text" id="phoneWitnesses" name="phoneWitnesses[]"
                                value="{{ old('phoneWitnesses') }}" placeholder="Masukan Nomor Telepon Saksi 3"
                                maxlength="20"
                                class="w-full mt-2 transition duration-500 ease-in-out rounded ring-1 ring-black focus:outline-none focus:ring-2 focus:ring-deep-koamaru-700 focus:border-transparent">
                            @error('phoneWitnesses')
                                <p class="mt-2 text-sm font-medium text-red-500">{{ $message }}</p>
